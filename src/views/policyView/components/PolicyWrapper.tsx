  ...
  return (
    <>
      ...
      <div className="policy-view-policy-wrapper">
        <h3>policy &#38; regler</h3>
        <p>Policy/regler gäller för Yogui Brazilian Jiu-Jitsu School (”klubben”), i dess lokaler och i samband med representationsaktiviteter för Yogui Brazilian Jiu-Jitsu School som tävlingar, träningar, uppvisningar i annan lokal nationellt som internationellt.</p>
      ...
      <div className="policy-view-policy-wrapper">
        <h3>värderingar</h3>
        <p>Yogui Brazilian Jiu-Jitsu School skall kännetecknas av följande värderingar:</p>
      ...
      <div className="policy-view-policy-wrapper">
        <h3>tävling</h3>
        <p>Som betalande medlem i Yogui Brazilian Jiu-Jitsu School har man möjlighet att tävla i klubbens namn i följande stilar: BJJ, NOGI &#38; SW. Att tävla för en annan klubb när man är betalande medlem hos Yogui Brazilian Jiu-Jitsu School är ej tillåtet (brott mot denna regel leder till uteslutning ur klubben och ingen återbetalning av terminsavgift).</p>
        <p>Vi lägger stor vikt vid att man har ett gott uppträdande när man representerar klubben vid tävling läger och andra event gentemot: andra deltagare, funktionärer, tränare, ledare och lokal. Yogui Brazilian Jiu-Jitsu School föregår med gott exempel och visar hjälpsamhet.</p>
      </div>
      ...
      <div className="policy-view-policy-wrapper">
        ...
        <p>Enligt svensk lag gäller 18 år som förtäring av alkohol. Alkohol är en drog och därför förekommer den inte i Yogui Brazilian Jiu-Jitsu School ordinarie verksamhet. Där verksamhet riktar sig mot barn och ungdomar under 18 år gäller total avhållsamhet från alkohol.</p>
        <p>Narkotika, och liknande preparat, är förbjudet enligt lag och det gäller även inom Yogui Brazilian Jiu-Jitsu School verksamhet.</p>
        <p>Dopningspreparat är ett otillåtet medel och får inte förekomma i någon form inom Yogui Brazilian Jiu-Jitsu School verksamhet.</p>
      </div>
      ...
      <div className="policy-view-policy-wrapper">
        ...
        <p>Det finns ett antal regler kopplat till utövandet våra stilar. Det finns regler om medlemsavgifter, uppföranderegler, regler kopplade till kast och träning samt tävlingsregler.
          De lokala uppföranderegler som Yogui Brazilian Jiu-Jitsu School är följande:</p>

        <p>• Alla är välkomna att prova-på ett pass innan man tecknar – helt gratis.</p>
        <p>• Efter prova-på så betalar man snarast in terminsavgiften och köper träningsutrustning som krävs för att träna. Yogui Brazipan Jiu-Jitsu School   kan hjälpa till med det.</p>
